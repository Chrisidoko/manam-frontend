...
export default function Products() {
  return (
    <section
      ...
      className="flex animate-slide-up-fade flex-col items-center justify-center gap-y-3 text-center sm:mt-1"
      style={{ animationDuration: "1500ms" }}
    >
      <h3 className="mt-20 text-[#0095da]">WHAT WE DO</h3>
      <h2 className="w-full sm:w-[70%] inline-block bg-gradient-to-br from-gray-900 to-gray-800 bg-clip-text py-2 text-2xl font-bold tracking-tighter text-transparent sm:text-4xl">
      ...
      <div className="sm:mt-8 flex flex-col items-center sm:flex-row sm:items-start gap-4 justify-between px-2 py-6 md:gap-10  md:px-50">
        {features.map((item) => (
          <div
            key={item.name}
            className="flex flex-col px-6 py-5 items-center w-[80%] sm:w-[36%] gap-2 rounded-xl  hover:bg-[#e0f2fe] ring-2 ring-gray-200/80 hover:ring-[#0395da] transform transition duration-400 hover:-translate-y-2 shadow-lg"
          >
